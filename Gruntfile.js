 ...
 * @Description A simple frontend work-flow solution for light one page webapp by grunt
 ...
 * @Version 2.0 | 2015-11-22 | SeasonLi    // Use spm to manage js modules and strongify build tools
 **/
...
module.exports = function (grunt) {
  ...
  grunt.task.registerTask('getTime', function () {
    grunt.config.set('htmlbuild.dev.options.data.time', new Date().getTime());
    grunt.config.set('htmlbuild.release.files.data.time', new Date().getTime());
  });
